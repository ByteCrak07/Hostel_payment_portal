...
function Sidebar(props) {
    ...
    let [option_class1, option_class2, option_class3] = ["option", "option", "option"];
        ...
        <div className={sideboard_class}>
            <div className="container">
                <div className="head" onClick={() => props.collapseToggle()}>
                    ...
                    <div className="text">&nbsp;GECT&nbsp;PORTAL</div>
                </div>
                <hr />
                <div className={option_class1} onClick={() => props.routeToggle("profile")}>
                    <div className="col">
                        <span className="fa fa-user fa-2x"></span><span className="text">&nbsp;USER PROFILE</span>
                    </div>
                </div>  
                <div className={option_class2} onClick={() => props.routeToggle("payment")}>
                    <div className="col">
                        <span className="fa fa-credit-card-alt fa-2x"></span><span className="text">&nbsp;PAY MY FEE</span>
                    </div>
                </div>  
                <div className={option_class3} onClick={() => props.routeToggle("notifications")}>
                    <div className="col">
